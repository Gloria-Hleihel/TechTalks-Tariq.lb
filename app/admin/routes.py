...
def dashboard():
    ...
    severity_counts = {
        ...
        "Medium": Detection.query.filter_by(
            severity_label="Medium"
        ).count(),
        "High": Detection.query.filter_by(
            severity_label="High"
        ).count(),
        "Critical": Detection.query.filter_by(
    ...
    damage_counts = {
        ...
        "Potholes": Detection.query.filter_by(
            damage_type="Potholes"
        ).count(),
        "None": Detection.query.filter_by(
            damage_type="None"
        ).count(),
    }
